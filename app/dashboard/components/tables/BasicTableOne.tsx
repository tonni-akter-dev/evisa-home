...
const handleDelete = async (id: string): Promise<void> => {
  ...
  return (
    <div className="overflow-x-auto shadow-lg rounded-xl border border-gray-200 bg-white dark:border-white/[0.05] dark:bg-white/[0.03]">
                ...
                <TableRow key={visa._id}>
                  ...
                  <TableCell className="px-3 py-3">
                    <div className="flex gap-2">
                      <Link
                        href={`/dashboard/edit-visa/${visa._id}`}
